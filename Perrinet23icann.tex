...
TODO read and cite~\cite{Mackevicius2019} wesh
...
\begin{figure}%[t!]
  \centering
  \includegraphics[width=0.90\linewidth]{figures/izhikevich.pdf}%png}% https://www.overleaf.com/5625872443qpcwrkssgbsf
...
Assuming that we know that there are $M$ such motifs, we define $b \in [1, M]$ the address of a motif and $W_b$ the corresponding weight matrices. This allows us to derive a generative model for raster plots (see \fig{THC}).
